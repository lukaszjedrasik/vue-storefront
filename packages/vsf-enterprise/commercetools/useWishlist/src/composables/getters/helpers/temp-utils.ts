...
import { DiscountedLineItemPrice, ProductVariant, ProductPrice, DiscountedProductPriceValue, LineItem } from '@vue-storefront/commercetools-api/src/types/GraphQL';
